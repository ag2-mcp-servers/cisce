...
#   timestamp: 2025-06-28T14:55:54+00:00
...
class CertificateParameters(BaseModel):
    CUID: str = Field(..., description='Candidate ID', examples=['6374638'])
    DOB: str = Field(
    ...
    IDXN: str = Field(..., description='Index Number', examples=['1234567/001'])
    UID: str = Field(..., description='Aadhaar number', examples=['123412341234'])
    YOE: str = Field(..., description='Year Of Examination -YYYY', examples=['2016'])
